   ...
   <!-- Page Header Start -->
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h2 class="display-3 text-white mb-3 animated slideInDown">5일 구독</h2>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                	<!--뭐 넣을까-->
<!--                     <li class="breadcrumb-item"><a class="text-white" href="#">3일 구독</a></li> -->
                    <li class="breadcrumb-item" style = "font-size:25px;"><a class="text-white" href="threeSub.do"  >3일 구독</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="container-xxl py-5">
        <div class="container">
            <h1  style = "font-size:40px;">5일구독</h1>
             <div class="container-xxl py-5">
        <div class="container">
