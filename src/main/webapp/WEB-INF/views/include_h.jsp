...
=======
                    <small>카카오톡 상담 가능 시간 Mon - Fri : 09.00 AM - 06.00 PM</small>
                </div>
            </div>
            <div class="col-lg-5 px-5 text-end">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="Mypage.do" class="nav-item nav-link">나의 味</a>
                 ...
                 <!-- 드롭다운 -->
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">나의 味</a>
                <div class="dropdown-menu fade-up m-0">
                    <a href="getIncome.do" class="dropdown-item">매출관리</a>
                    <a href="getMenuList.do" class="dropdown-item">메뉴관리</a>
                    <a href="getMemberList.do" class="dropdown-item">회원관리</a>
                    <a href="getOrderList.do" class="dropdown-item">주문관리</a>
                </div>
            </div>
