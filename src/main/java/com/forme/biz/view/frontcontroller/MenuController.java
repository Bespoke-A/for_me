...
public class MenuController {
	...
	@RequestMapping("/threeSub.do")
	public String threeSub(MenuVO vo, Model model) {
		System.out.println("🌐threeSub.jsp 접속");
		System.out.println("ᵔᴥᵔ게시글 전체 목록 보여주기");
		List<MenuVO> listSix = menuService.getThumSix();
		System.out.println(listSix);
		List<MenuVO> listEight = menuService.getThumEight();
	...
	@RequestMapping("/fiveSub.do")
	public String fiveSub(MenuVO vo, Model model) {
		System.out.println("🌐fiveSub.jsp 접속");
		List<MenuVO> listSix = menuService.getThumSix();
		System.out.println(listSix);
		List<MenuVO> listEight = menuService.getThumEight();
		System.out.println(listEight);
