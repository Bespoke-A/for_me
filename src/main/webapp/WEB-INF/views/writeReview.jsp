...
<style>
	...
	#myform>input:nth-child(n+2):hover{
...
<jsp:include page="/WEB-INF/views/include_h.jsp"/>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">味 담</h1>
         	<ol class="breadcrumb">
          		<li class="breadcrumb-item"><p class="text-white">리뷰 작성</p></li>
            </ol>
    ...
    <!-- Page Header End -->
 	<div class="text-center">
		...
		<div>
			<textarea class="col-auto" name="comments"  id="reviewContents"
